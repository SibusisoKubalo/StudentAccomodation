...
public class LandlordRegistration extends JFrame implements ActionListener{
    ...
    public LandlordRegistration() {
        ...
        JLabel lblNewUserRegister = new JLabel("StudentAcc Landlord Registration");
        ...
        building.setFont(new Font("roman", Font.ITALIC, 12));
        building.setBounds(150,300,200,30);
        ...
        btnNewButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    Connection connection = DriverManager.getConnection("jdbc:sqlite:Database\\Landlord.db");
                    System.out.println("Connection established");
                    String query = "INSERT INTO landlord values('" + firstName + "','" + lastName + "','" + mobileNumber + "','" + building  + "')";
